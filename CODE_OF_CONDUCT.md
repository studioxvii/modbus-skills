...
Report unacceptable behavior through GitHub private vulnerability reporting on
[studioxvii/modbus-skills](https://github.com/studioxvii/modbus-skills), and
label the report as a community concern rather than a product vulnerability.
Do not include credentials, customer files, or vendor documents.
...
3. **Temporary ban.** A temporary ban from interaction for a specified period.
