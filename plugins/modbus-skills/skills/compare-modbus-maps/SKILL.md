...
3. Report added, removed, changed, and unresolved points.
4. Highlight changes to address, area, unit identifier, datatype, width, access, scale, byte order, enum values, and evidence.
